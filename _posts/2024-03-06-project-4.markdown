...
<div id="mc-project-4">
  ...
  <div id="mc-quiz-container" style="display: none;">
    ...
    <!-- Question 1: Updated for Category 1 -->
    ...
    <!-- Question 2: Updated for Category 1 -->
    ...
    <!-- Question 3 Placeholder (Updated with 4 options) -->
    <div class="quiz-question" id="mc-question-3" style="display: none;">
      ...
      <div class="button-group">
        ...
        <button class="mc-option option-d" onclick="mcProj.selectChoice('D', 3, event)">Option D</button>
      </div>
    ...
    <!-- Question 4 Placeholder (Updated with 4 options) -->
    <div class="quiz-question" id="mc-question-4" style="display: none;">
      ...
      <div class="button-group">
        ...
        <button class="mc-option option-d" onclick="mcProj.selectChoice('D', 4, event)">Option D</button>
      </div>
    ...
    <!-- Question 5 Placeholder (Updated with 4 options) -->
    <div class="quiz-question" id="mc-question-5" style="display: none;">
      ...
      <div class="button-group">
        ...
        <button class="mc-option option-d" onclick="mcProj.selectChoice('D', 5, event)">Option D</button>
      </div>
    ...
    <!-- Question 6 Placeholder (Updated with 4 options) -->
    <div class="quiz-question" id="mc-question-6" style="display: none;">
      ...
      <div class="button-group">
        ...
        <button class="mc-option option-d" onclick="mcProj.selectChoice('D', 6, event)">Option D</button>
      </div>
    ...
    <!-- Question 7 Placeholder (Updated with 4 options) -->
    <div class="quiz-question" id="mc-question-7" style="display: none;">
      ...
      <div class="button-group">
        ...
        <button class="mc-option option-d" onclick="mcProj.selectChoice('D', 7, event)">Option D</button>
      </div>
    ...
    <!-- Question 8 Placeholder (Updated with 4 options) -->
    <div class="quiz-question" id="mc-question-8" style="display: none;">
      ...
      <div class="button-group">
        ...
        <button class="mc-option option-d" onclick="mcProj.selectChoice('D', 8, event)">Option D</button>
      </div>
    ...
    <!-- Question 9 Placeholder (Updated with 4 options) -->
    <div class="quiz-question" id="mc-question-9" style="display: none;">
      ...
      <div class="button-group">
        ...
        <button class="mc-option option-d" onclick="mcProj.selectChoice('D', 9, event)">Option D</button>
      </div>
    ...
    <!-- Question 10 Placeholder (Updated with 4 options) -->
    <div class="quiz-question" id="mc-question-10" style="display: none;">
      ...
      <div class="button-group">
        ...
        <button class="mc-option option-d" onclick="mcProj.selectChoice('D', 10, event)">Option D</button>
      </div>
