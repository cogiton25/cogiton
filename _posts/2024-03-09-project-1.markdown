...
<div class="quiz-container">
  ...
  <div class="quiz-question" id="question-1">
    ...
    <button class="clear-btn" onclick="clearChoice(1)">Clear</button>
  ...
  <div class="quiz-question" id="question-2" style="display: none;">
    ...
    <button class="clear-btn" onclick="clearChoice(2)">Clear</button>
  ...
  <div class="quiz-question" id="question-3" style="display: none;">
    ...
    <button class="clear-btn" onclick="clearChoice(3)">Clear</button>
  ...
  <div class="quiz-question" id="question-4" style="display: none;">
    ...
    <button class="clear-btn" onclick="clearChoice(4)">Clear</button>
  ...
  <div class="quiz-question" id="question-5" style="display: none;">
    ...
    <button class="clear-btn" onclick="clearChoice(5)">Clear</button>
  ...
  <div class="quiz-question" id="question-7" style="display: none;">
    ...
    <button class="clear-btn" onclick="clearChoice(7)">Clear</button>
  ...
  <div class="quiz-question" id="question-8" style="display: none;">
    ...
    <button class="clear-btn" onclick="clearChoice(8)">Clear</button>
    <div class="answer" id="answer-8">
      <strong>Real.</strong> The systematic review and meta-analysis by Chan and colleagues (2023) shows substance-use-disorders are associated with the years of potential life (YPLL) with an average of approximately 20.38 years lost relative to the general population. 
      <br>(<a href="https://doi.org/10.1073/pnas.2405334121" target="_blank">DOI: 10.1371/journal.pbio.3002176.</a>)
    </div>
  </div>  
  ...
  <div class="quiz-question" id="question-9" style="display: none;">
    ...
    <button class="clear-btn" onclick="clearChoice(9)">Clear</button>
  ...
  <div class="quiz-question" id="question-10" style="display: none;">
    ...
    <button class="clear-btn" onclick="clearChoice(10)">Clear</button>
...
.clear-btn { background-color: #FF9800; margin-top: 20px; }
.answer {
  font-size: 16px;
  display: none;
  margin-top: 20px;
...
// Function to clear a user's choice and hide the answer, allowing a change
function clearChoice(questionNum) {
  // Remove the user's selection
  delete userChoices[questionNum];
  // Hide the answer if displayed
  document.getElementById('answer-' + questionNum).style.display = 'none';
  // Reset opacity for all buttons in the question's button group
  const parent = document.getElementById('question-' + questionNum).querySelector('.button-group');
  const buttons = parent.querySelectorAll('button');
  buttons.forEach(function(btn) {
    btn.style.opacity = '1';
  });
